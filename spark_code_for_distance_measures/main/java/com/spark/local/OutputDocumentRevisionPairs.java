...
public class OutputDocumentRevisionPairs {
	private String inputPath, fileNameFolder, matrixFolder, 
		dtwFolder, word2vecFolder, outputFolder;
	//private static ParagraphVector paragraphVector;
    private boolean hasWord2vec; 
    // dtw tao
    private static double dtw_threshold = Double.POSITIVE_INFINITY;
	...
	public OutputDocumentRevisionPairs(SetParameters setParameters,
	    ...
	    this.dtwFolder = setParameters.getDtwFolder();
	...
	public static void main(String[] args) {
	    ...
	    OutputDocumentRevisionPairs outputDocumentRevisionPairs = 
	    		new OutputDocumentRevisionPairs(setParameters, sparkContext, sc);
...
//				.filter(new FilterSmallSimilarities());
		...
		JavaPairRDD<String, String> doc_parent_rdd = indexValues
		...
		System.out.println("revised_old_distance_RDD " + revised_old_distance_RDD.take(6));
//		revised_old_distance_RDD.saveAsTextFile(outputDocumentRevisionPairs.getDtwFolder());	
//		// end of cal DTW dist
//		
//		//JavaRDD<String> dtw_lines = sc.textFile(outputDocumentRevisionPairs.getDtwFolder());
...
//			}catch (Exception e){
//				System.out.println("revised_doc_fileName " + revised_doc_fileName + " old_doc_fileName " + old_doc_fileName);
