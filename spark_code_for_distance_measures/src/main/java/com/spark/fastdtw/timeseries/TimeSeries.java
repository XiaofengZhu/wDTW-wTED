...
package com.spark.fastdtw.timeseries;

import java.util.ArrayList;
import java.util.StringTokenizer;
import java.util.Vector;

import com.spark.fastdtw.util.Arrays;
...
public class TimeSeries implements Serializable
{
   ...
   public TimeSeries(String paragraph_vector_string)
   {
      this();
...
//         }  // end if
         ...
         if (paragraph_vector_string != null){
	         // Read in all of the values in the data file.
	         for (String word_vector_string: paragraph_vector_string.split(" "))   // read lines until end of file
	         {
	            if (word_vector_string.length() > 0)  // ignore empty lines
	            {
	               st = new StringTokenizer(word_vector_string.replaceAll("\\[", "").replaceAll("\\]", "")
	            		   , ",");
