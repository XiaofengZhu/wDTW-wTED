...
import com.spark.fastdtw.dtw.SearchWindow;
import com.spark.fastdtw.dtw.TimeWarpInfo;
import com.spark.fastdtw.dtw.WarpPath;
import com.spark.fastdtw.dtw.WarpPathWindow;
import com.spark.fastdtw.timeseries.PAA;
...
public class AbstractionTest
{
      ...
      public static void main(String[] args)
      {
         ...
         else
         {
            ...
            final WarpPath coarsePath = com.spark.fastdtw.dtw.DTW.getWarpPathBetween(shrunkI, shrunkJ, distFn);
            ...
            final TimeWarpInfo info = com.spark.fastdtw.dtw.DTW.getWarpInfoBetween(tsI, tsJ, w, distFn);
