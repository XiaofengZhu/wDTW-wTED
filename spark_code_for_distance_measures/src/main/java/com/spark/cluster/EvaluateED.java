...
public class EvaluateED {
	private String inputPath, fileNameFolder, matrixFolder, edFolder;
	...
	public String getEDFolder() {
		return edFolder;
	}

	
	public EvaluateED(String inputPath, String fileNameFolder, String matrixFolder,
			String edFolder, SparkContext sparkContext, JavaSparkContext sc){ 
		this.inputPath = inputPath;   	
		this.fileNameFolder = fileNameFolder;		
		this.matrixFolder = matrixFolder;
		this.edFolder = edFolder;
	...
	public static void main(String[] args) {
	    ...
	    EvaluateED outputDocumentRevisionPairs = 
	    		new EvaluateED(args[0], args[1], args[2], 
		...
		public Tuple2<String, Double> call(
			...
			try{
				revisedDoc_oLdDoc_distance = dTW4DocPair
					.getEditDist(revised_doc_content, old_doc_content);
			}catch (Exception e){
				System.err.println("revised_doc_fileName " + revised_doc_fileName 
						+ " old_doc_vector_content " + old_doc_content 
						+ e.getMessage());
			}
