...
public class EvaluatePVTED {
		...
		public EvaluatePVTED(String inputPath, String fileNameFolder, String matrixFolder,
	...
	public static void main(String[] args) {
	    ...
	    EvaluatePVTED outputDocumentRevisionPairs = 
	    		new EvaluatePVTED(args[0], args[1], args[2], 
