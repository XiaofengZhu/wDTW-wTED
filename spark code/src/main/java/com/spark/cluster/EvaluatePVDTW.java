...
public class EvaluatePVDTW {
	...
	public EvaluatePVDTW(String inputPath, String fileNameFolder, String matrixFolder,
	...
	public static void main(String[] args) {
	    ...
	    EvaluatePVDTW outputDocumentRevisionPairs = 
	    		new EvaluatePVDTW(args[0], args[1], args[2], 
