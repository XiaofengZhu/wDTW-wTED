...
import com.spark.wmd.AverageWordEmbeddingPair;
...
public class CalAWE {
	...
	public CalAWE(String inputPath, String fileNameFolder, String matrixFolder, 
	...
	public static void main(String[] args) {
	    ...
	    CalAWE outputDocumentRevisionPairs = 
	    		new CalAWE(args[0], args[1], args[2], 
...
//	};
	...
	PairFunction<Tuple2<Tuple2<String, String>, Tuple2<String, String>>, String, Double>{
		...
		public Tuple2<String, Double> call(
			...
			AverageWordEmbeddingPair awe4DocPair = new AverageWordEmbeddingPair();
...
//			}
			revisedDoc_oLdDoc_distance = awe4DocPair
					.getAvgDist(revised_doc_vector_content, old_doc_vector_content);
