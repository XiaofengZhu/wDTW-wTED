...
public class EvaluateWMD {
	...
	public EvaluateWMD(String inputPath, String fileNameFolder, String matrixFolder, 
	...
	public static void main(String[] args) {
	    ...
	    EvaluateWMD outputDocumentRevisionPairs = 
	    		new EvaluateWMD(args[0], args[1], args[2], 
