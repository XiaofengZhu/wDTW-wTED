...
public class CalwTED {
	...
	public CalwTED(String inputPath, String fileNameFolder, String matrixFolder, 
	...
	public static void main(String[] args) {
	    ...
	    CalwTED outputDocumentRevisionPairs = 
	    		new CalwTED(args[0], args[1], args[2], 
