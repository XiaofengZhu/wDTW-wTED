...
import com.spark.tree.edit.distance.test.CorrectnessTest;
import com.spark.word2vec.ParagraphVector;

import scala.Tuple2;

public class EvaluatewTED {
	private String inputPath, fileNameFolder, matrixFolder, 
	tedFolder, word2vecFolder;
	...
	public EvaluatewTED(String inputPath, String fileNameFolder, String matrixFolder, 
			String tedFolder, String word2vecFolder, 
			SparkContext sparkContext, JavaSparkContext sc){ 
		this.inputPath = inputPath;   	
		this.fileNameFolder = fileNameFolder;		
		this.matrixFolder = matrixFolder;
		this.tedFolder = tedFolder;
	...
	public EvaluatewTED(String inputPath, String fileNameFolder, String matrixFolder, 
			String tedFolder, String word2vecFolder, boolean hasWord2vec,
			SparkContext sparkContext, JavaSparkContext sc){ 
		this.inputPath = inputPath;   	
		this.fileNameFolder = fileNameFolder;		
		this.matrixFolder = matrixFolder;
	...
	public EvaluatewTED(String inputPath, String fileNameFolder, String matrixFolder, 
			String tedFolder, String word2vecFolder, String database, String username, String password, 
	...
	public static void main(String[] args) {
	    ...
	    .setAppName("Document Revision - wTED")
	    .setMaster("local[*]")
		.set("spark.kryoserializer.buffer.max", "1g")
		.set("spark.yarn.executor.memoryOverhead", "409")		
	    ...
	    EvaluatewTED outputDocumentRevisionPairs = 
	    		new EvaluatewTED(args[0], args[1], args[2], 
...
//		    		outputDocumentRevisionPairs.getWord2vecFolder());			
		...
		JavaRDD<String> fileNames_lines = sc
				.textFile(outputDocumentRevisionPairs.getFileNameFolder());//, 20000
		final Broadcast<List<String>> fileName_list_broadcast = sc
				.broadcast(fileNames_lines.collect());
	    
		JavaRDD<String> matrix_lines = 
				sc.textFile(outputDocumentRevisionPairs.getMatrixFolder());//, 20000
		...
		revised_old_distance_RDD.saveAsTextFile(outputDocumentRevisionPairs.getTedFolder());	
		// end of cal DTW dist
		
//		//JavaRDD<String> dtw_lines = sc.textFile(outputDocumentRevisionPairs.getTedFolder());
...
//		
//		ted_threshold = outputDocumentRevisionPairs.findDeri(threshld_count_list);
//		*/
//		System.err.println("ted_threshold is " + ted_threshold);
//		final Broadcast<Double> ted_threshold_broadCast = sc.broadcast(ted_threshold);		
//		// End of estimating the optimal tau
//		
//		JavaPairRDD<String, Double> dtw_filtered_indexValues;
//		if (ted_threshold < Double.POSITIVE_INFINITY){
...
//							if (s._2() <= ted_threshold_broadCast.value()) 
//								return true; 
//							return false; }
//			});			
//		}else{
...
//		System.out.println("doc_parent_rdd " + doc_parentDist_rdd.take(2));
//		
...
//		System.out.println("precision-ted_threshold-"+ted_threshold+": " +precision);
//		System.out.println("recall-ted_threshold-"+ted_threshold+": " +recall);	
//		System.out.println("f-measure-ted_threshold-"+ted_threshold+": " +f_measure);
//		
...
//		private static final long serialVersionUID = 1L;
//
//		public Boolean call(Tuple2<String, Double> s) { if (s._2() < ted_threshold) return true; return false; }
//	};
	...
	PairFunction<Tuple2<Tuple2<String, String>, Tuple2<String, String>>, String, Double>{
		...
		public Tuple2<String, Double> call(Tuple2<Tuple2<String, String>, Tuple2<String, String>> x)
			...
			CorrectnessTest editTreeDistanceTest = new CorrectnessTest();
