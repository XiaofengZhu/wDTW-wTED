...
public class CalwDTW {
	...
	public CalwDTW(String inputPath, String fileNameFolder, String matrixFolder, 
	...
	public static void main(String[] args) {
	    ...
	    CalwDTW outputDocumentRevisionPairs = 
	    		new CalwDTW(args[0], args[1], args[2], 
